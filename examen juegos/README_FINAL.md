...
1. **Intro** (30 seg) - Preséntate y da contexto
2. **Narrativa** (1 min) - Explica la historia
3. **Mecánicas** (1.5 min) - Demuestra gameplay
4. **Arte y Audio** (1.5 min) - Muestra animaciones y sonido
5. **Arquitectura** (1.5 min) - Explica la estructura técnica
6. **Requisitos** (1 min) - Verifica que todo está hecho
7. **Conclusión** (0.5 min) - Resumen final
8. **Demo en Vivo** (1.5 min) - Juega una partida completa

**Total: 10 minutos exactos**

### Tips para la Grabación

📹 **Antes de grabar**:
- Prueba el juego 2-3 veces
- Asegúrate de que el servidor está corriendo
- Verifica que el micrófono funciona bien
- Ten una partida ganada lista para mostrar

🎙️ **Durante la grabación**:
- Habla con claridad y confianza
- Mantén energía entusiasta
- Pausa después de puntos clave
- Deja que el gameplay hable por sí solo
- Si algo falla, continúa como si nada

✂️ **Después de grabar**:
- Edita el video con título y transiciones
- Agrega B-roll del gameplay
- Sube subtítulos en español
- Incluye créditos finales
...
Si quieres mejorar más el proyecto después de la evaluación:

1. **Más Niveles**: Crear nivel 2, 3 con dificultad progresiva
2. **Powerups**: Escudo temporal, velocidad boost, etc.
3. **IA Mejorada**: Enemigos que persiguen, no solo patrullan
4. **Leaderboard**: Sistema de puntuaciones altas
5. **Efectos Visuales**: Partículas, camera shake, etc.
6. **Controles de Dificultad**: Fácil/Normal/Difícil
7. **Más Enemigos**: Aumentar desafío en niveles posteriores

---

## ❓ PREGUNTAS FRECUENTES

**P: ¿El juego funciona en celular?**
A: Sí, pero los controles son solo teclado por ahora. En celular necesitarías implementar joystick virtual.

**P: ¿Por qué 90 segundos?**
A: Es suficiente pero apretado. Crea tensión sin ser imposible.

**P: ¿Puedo cambiar las gemas a 3?**
A: Sí, solo cambia `if (this.score >= 5)` a `if (this.score >= 3)` en GameScene.js línea 186.

**P: ¿Cómo agrego más trampas o enemigos?**
A: Abre `assets/map/level1.json` y agrega más objetos en la capa "Objects".

**P: ¿El juego funciona sin internet?**
A: No, porque Phaser se carga desde CDN. Puedes descargarlo localmente si lo necesitas.
...
**Últimas Actualizaciones**: 4 de junio de 2026
